...
const features = [
  { icon: Heart, title: "Romantic Retreat", description: "Perfect hideaway for love birds seeking intimate moments amidst nature's beauty." },
  { icon: Compass, title: "Adventure Awaits", description: "Explore aquatic wonders, island trails, and unforgettable experiences." },
  { icon: Waves, title: "Aquatic Serenity", description: "Surrounded by serene waters and the gentle rhythm of nature." },
  { icon: Home, title: "Home Away", description: "Experience warm Ghanaian hospitality in a luxurious setting." },
];
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="relative">
            <div className="relative rounded-2xl overflow-hidden shadow-elevation-5">
              <img src={paradasiaAerialNight} alt="Paradasia Hideway glowing under the stars — your island sanctuary awaits" className="w-full h-[300px] sm:h-[400px] lg:h-[500px] object-cover" />
            ...
            <div className="absolute -bottom-6 right-2 sm:-bottom-8 sm:-right-8 bg-card rounded-2xl p-4 sm:p-6 shadow-elevation-5 max-w-[220px] sm:max-w-[280px] border border-brand-orange/20">
              <div className="flex items-center gap-3 sm:gap-4 mb-3">
                <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-full bg-gradient-to-br from-brand-orange-dark to-brand-orange flex items-center justify-center">
                  <span className="font-display text-white text-lg sm:text-2xl font-bold">5★</span>
                </div>
                <div>
            ...
            {/* Decorative Border */}
            <div className="absolute -top-4 -left-4 w-full h-full border-2 border-brand-orange/15 rounded-2xl -z-10 hidden sm:block" />
          </div>

          {/* Content Side */}
          <div>
            <span className="inline-block text-brand-orange text-sm tracking-widest uppercase mb-4">Welcome to Paradise</span>
            <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl text-foreground mb-6 leading-tight">
              Where Tradition Meets<span className="text-orange-gradient block">Elegance</span>
            </h2>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {features.map((feature) => (
                <div key={feature.title} className="group p-5 rounded-xl bg-muted/50 hover:bg-accent/50 border border-transparent hover:border-brand-orange/20 transition-all duration-300">
